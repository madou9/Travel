...
const Footer = () => {
  return (
    ...
    <div id='waveBg' className='absolute hidden md:block'>
    ...
    <div className='flex flex-col relative md:justify-between md:flex-row '>
      ...
      <div className='flex flex-col md:my-0 mt-12 gap-4'>
        ...
        <div className='flex flex-col gap-5 items-start justify-center'>
          <h2 className='font-inter font-medium text-md mx-5 text-gray-600'>(+49) 2678666</h2>
          <h2 className='font-inter font-medium text-md mx-3 text-gray-600'>info@travlog.com</h2>
          <h2 className='font-inter font-medium text-md text-gray-600'>Goppelstraße, Heilbronn<br/> Germany</h2>
        </div>
      </div>
